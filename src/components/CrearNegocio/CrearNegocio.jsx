...
export const CrearNegocio = () => {
    return (
        <section className="form-register">
            <h4>Crea Tu Negocio</h4>
            <label htmlFor="nombreNegocio">Nombre del negocio</label>
            <input className="controls" type="text"  name="nombreNegocio" id="nombreNegocio" placeholder="Ejemplo: panapp"/> 
            ...
            <label htmlFor="imagen">Imagen de tu negocio</label><br />
            <input type="file" />
